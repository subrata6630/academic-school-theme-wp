...
?>
					...
					<!--================================
							Information Archive-Page-start
                      ===============================-->        
                    ...
                    <tbody>
                        <tr>
                          <th class="inform"><?php echo get_the_time("F j, Y"); ?></th>
                            ...
                            <td class="viwe"><a href="<?php the_permalink();?>"><i class="fa fa-eye"></i><?php echo get_post_meta(get_the_ID(),'inform-viw', true); ?></a></td>
