...
function newsstar_css_and_js() {
   ...
   wp_register_style('menu',get_template_directory_uri() .'/assets/css/menu.css');
   wp_register_style('owl_carousel_min',get_template_directory_uri() .'/assets/css/owl.carousel.min.css');
   wp_register_style('magnific_popup',get_template_directory_uri() .'/assets/css/magnific-popup.css');
   wp_register_style('animate',get_template_directory_uri() .'/assets/css/animate.css');
   wp_register_style('stylesheet',get_template_directory_uri() .'/assets/css/stylesheet.css');
   wp_register_style('style',get_stylesheet_uri() );
    
	
	
	
    wp_register_script('js_min', get_template_directory_uri() .'/assets/js/bootstrap.min.js', array(
    'jquery'));
	wp_register_script('jquery-min', get_template_directory_uri() .'/assets/js/jquery.min.js', array());
	wp_register_script('owl_carousel_min', get_template_directory_uri() .'/assets/js/owl.carousel.min.js', array());
	wp_register_script('jquery_magnific_popup', get_template_directory_uri() .'/assets/js/jquery.magnific-popup.min.js', array());
	wp_register_script('counterup_min', get_template_directory_uri() .'/assets/js/counterup.min.js', array());
	wp_register_script('waypoints_min', get_template_directory_uri() .'/assets/js/waypoints.min.js', array());
	wp_register_script('wow', get_template_directory_uri() .'/assets/js/wow.js', array());
	wp_register_script('main', get_template_directory_uri() .'/assets/js/main.js', array());
    ...
    wp_enqueue_script('counterup_min');
...
require_once dirname( __FILE__ ) . '/lib/tgm/example.php';